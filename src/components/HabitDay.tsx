    ...
    <Popover.Root>
      <Popover.Trigger className={clsx('w-10 h-10  rounded-lg',
        {
          ...
          'bg-violet-500 border-violet-400': completedPercentage >= 0 && completed < 20,
          'bg-violet-600 border-violet-500': completedPercentage >= 20 && completed < 40,
          'bg-violet-700 border-violet-500': completedPercentage >= 40 && completed < 60,
          'bg-violet-800 border-violet-600': completedPercentage >= 60 && completed < 80,
      ...
      <Popover.Portal>
        <Popover.Content className='min-w-[340px] p-6 rounded-2xl bg-zinc-900 flex flex-col'>
          ...
          <span className='mt-1 font-extrabold leading-tight text-3xl'>06/02</span>
